...
const links = [
  ...
  },
  {
    ...
    context: 'Explore the Next.js 13 playground.',
  },
  {
    title: 'Deploy',
    ...
    <main className='flex min-h-screen flex-col items-center justify-between p-24'>
      <div className='z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex'>
        <p className='fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30'>
          ...
          <code className='font-mono font-bold'>src/app/protected/page.tsx</code>
        </p>
        {!session && (
          <p className='flex w-full justify-center border-2 border-b border-red-300 bg-red-200 pb-6 pt-8 backdrop-blur-2xl dark:border-red-800 dark:bg-red-800/30 lg:static lg:w-auto lg:rounded-xl lg:p-4 lg:dark:bg-red-800/50'>
            UNPROTECTED
          </p>
        )}
        {session && (
          <p className='flex w-full justify-center border-2 border-b border-green-300 bg-green-200 pb-6 pt-8 backdrop-blur-2xl dark:border-green-800 dark:bg-green-800/30 lg:static lg:w-auto lg:rounded-xl lg:p-4 lg:dark:bg-green-800/50'>
            PROTECTED
          </p>
        )}
      ...
      <div className='mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left'>
        {links.map((e) => (
          ...
          >
            ...
            <p className='m-0 max-w-[30ch] text-sm opacity-50'>{e.context}</p>
          </a>
        ))}
      </div>
    </main>
